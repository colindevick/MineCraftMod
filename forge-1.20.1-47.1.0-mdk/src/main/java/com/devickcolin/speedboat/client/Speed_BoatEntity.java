...
import com.devickcolin.speedboat.custom.core.ModEntityCreator;
import com.devickcolin.speedboat.custom.core.ModItemsBootStrap;
import com.devickcolin.speedboat.custom.items.EthonalItem;
...
public class Speed_BoatEntity extends Boat implements GeoEntity, net.minecraftforge.common.extensions.IForgeBoat {
	...
	private static final EntityDataAccessor<Float> DATA_ID_ROT = SynchedEntityData.defineId(Speed_BoatEntity.class,
			EntityDataSerializers.FLOAT);
	...
	public void registerControllers(ControllerRegistrar controllers) {
       controllers.add(new AnimationController<>(this, "turn", 1 , state -> state.setAndContinue(null)).setAnimationSpeed(.1));
	}
	...
	public Item getDropItem() {
		return ModItemsBootStrap.SPEEDBOAT.get();
	}
	...
	public float getRotation() {
		return this.entityData.get(DATA_ID_ROT);
	}
	
	public void setRotation(float rotation) {
		this.entityData.set(DATA_ID_ROT, rotation);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(DATA_ID_ROT, 0.0F);
	}
