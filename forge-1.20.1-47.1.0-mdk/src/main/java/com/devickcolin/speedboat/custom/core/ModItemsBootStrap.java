...
import com.devickcolin.speedboat.custom.items.SpeedBoatItem;
...
public class ModItemsBootStrap {
		...
		public static final RegistryObject<ItemNameBlockItem> CORN_KERNALS = ITEMS.register("kernals_corn",
				() -> new ItemNameBlockItem(ModBlocksBootStrap.CORN_CROP.get(),new ItemNameBlockItem.Properties().stacksTo(64)));
