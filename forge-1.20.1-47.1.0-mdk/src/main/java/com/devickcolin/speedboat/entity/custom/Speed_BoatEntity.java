...
//@ TODO find out why boat doesn't float
...
public class Speed_BoatEntity extends Boat implements GeoEntity{
	private static final EntityDataAccessor<Integer> DATA_ID_BUBBLE_TIME = SynchedEntityData.defineId(Speed_BoatEntity.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Integer> DATA_ID_HURT = SynchedEntityData.defineId(Speed_BoatEntity.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Integer> DATA_ID_HURTDIR = SynchedEntityData.defineId(Speed_BoatEntity.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Float> DATA_ID_DAMAGE = SynchedEntityData.defineId(Speed_BoatEntity.class, EntityDataSerializers.FLOAT);
	...
	public void tick() {
	      ...
	      if (this.status != Speed_BoatEntity.Status.UNDER_WATER && this.status != Speed_BoatEntity.Status.UNDER_FLOWING_WATER) {
	...
	private void floatBoat() {
	      ...
	      if (this.oldStatus == Speed_BoatEntity.Status.IN_AIR && this.status != Speed_BoatEntity.Status.IN_AIR && this.status != Speed_BoatEntity.Status.ON_LAND) {
